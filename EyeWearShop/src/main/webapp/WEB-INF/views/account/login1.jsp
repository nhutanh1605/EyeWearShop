			...
			<div id="login">
				...
				<form action="/login1" method="post">
					...
					<div class="field-wrap">
						...
						</label> <input type="text" required autocomplete="off" name="username" value="${cookie.username.value}" required autofocus/>
					</div>

					<div class="field-wrap">
						<label> Password<span class="req">*</span>
						</label> <input type="password" required autocomplete="off" name="password" value="${cookie.password.value}" required  data-eye />
					</div>
					<!-- Remember me -->
					<div class="field-wrap form-check">
						...
						<label class="form-check-label ms-3"for="exampleCheck1">Remember me?</label>
